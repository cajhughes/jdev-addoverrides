...
public class OverrideMenuListener implements ContextMenuListener {
    @Override public void menuWillShow(final ContextMenu contextMenu) {
        contextMenu.add(contextMenu.createMenuItem(IdeAction.find(OverrideCommand.actionId())));
    }

    @Override public void menuWillHide(ContextMenu contextMenu) {
    }

    @Override public boolean handleDefaultAction(Context context) {
        return false;
    }
}
